package net.ilexiconn.bookwiki.client.component.recipe;
...
public class CraftingRecipe extends Gui implements IRecipe {
    ...
    @Override
    public void renderTooltip(Minecraft mc, BookWiki bookWiki, BookWikiContainer.Recipe recipe, int x, int y, int mouseX, int mouseY) {
        x += 14;
        y += mc.fontRendererObj.FONT_HEIGHT;
