...
public class AnimationVelociraptor implements IModelAnimator
{
    ...
    public void setRotationAngles(ModelJson model, float limbSwing, float limbSwingAmount, float rotation, float rotationYaw, float rotationPitch, float partialTicks, Entity entity) 
    {
        ...
        //
        //            //Idling
        //            model.chainWave(tailParts, 0.1F, -0.05F, 2, entity.ticksExisted, 1.0F - 0.5F * sittingProgress);
        //            model.walk(Neck, 0.1F, 0.07F, false, -1F, 0F, entity.ticksExisted, 1F - 0.3F * sittingProgress);
        //            model.walk(Head, 0.1F, 0.07F, true, 0F, 0F, entity.ticksExisted, 1F - 0.3F * sittingProgress);
        //            model.walk(Body_1, 0.1F, 0.05F, false, 0F, 0F, entity.ticksExisted, 1.0F - 0.7F * sittingProgress);
        //            model.chainWave(rightArmParts, 0.1F, -0.1F, 4, entity.ticksExisted, 1.0F - 0.5F * sittingProgress);
        //            model.chainWave(leftArmParts, 0.1F, -0.1F, 4, entity.ticksExisted, 1.0F - 0.5F * sittingProgress);
        //        }
        //        else
        //        {
