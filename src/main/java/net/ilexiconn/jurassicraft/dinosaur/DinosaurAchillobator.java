...
import net.ilexiconn.jurassicraft.client.model.animation.AnimationAchillobator;
import net.ilexiconn.jurassicraft.entity.EntityAchillobator;
...
public class DinosaurAchillobator extends Dinosaur
{
    ...
    public DinosaurAchillobator()
    {
        ...
        this.maleTextures = new String[] { "jurassicraft:textures/entities/achillobator/achillobator_male.png" };
        this.femaleTextures = new String[] { "jurassicraft:textures/entities/achillobator/achillobator_female.png" };

        try
        {
            this.model = getTabulaModel("/assets/jurassicraft/models/entities/achillobator");
        }
        catch (Exception e)
        {
            e.printStackTrace();
