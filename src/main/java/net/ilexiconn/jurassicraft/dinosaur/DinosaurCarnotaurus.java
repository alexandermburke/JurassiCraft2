...
import net.ilexiconn.jurassicraft.client.model.animation.AnimationCarnotaurus;
import net.ilexiconn.jurassicraft.entity.EntityCarnotaurus;
...
public class DinosaurCarnotaurus extends Dinosaur
{
    ...
    public DinosaurCarnotaurus()
    {
        ...
        this.maleTextures = new String[] { "jurassicraft:textures/entities/carnotaurus/carnotaurus_male.png" };
        this.femaleTextures = new String[] { "jurassicraft:textures/entities/carnotaurus/carnotaurus_female.png" };

        try
        {
            this.model = getTabulaModel("/assets/jurassicraft/models/entities/carnotaurus");
        }
        catch (Exception e)
        {
            e.printStackTrace();
