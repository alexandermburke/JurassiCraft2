...
import net.ilexiconn.jurassicraft.client.model.animation.AnimationDilophosaurus;
import net.ilexiconn.jurassicraft.entity.EntityDilophosaurus;
...
public class DinosaurDilophosaurus extends Dinosaur
{
    ...
    public DinosaurDilophosaurus()
    {
        ...
        this.maleTextures = new String[] { "jurassicraft:textures/entities/dilophosaurus/dilophosaurus_male.png" };
        this.femaleTextures = new String[] { "jurassicraft:textures/entities/dilophosaurus/dilophosaurus_female.png" };

        try
        {
            this.model = getTabulaModel("/assets/jurassicraft/models/entities/dilophosaurus");
        }
        catch (Exception e)
        {
            e.printStackTrace();
