...
public class AIExtendedEntity implements IExtendedEntityProperties
{
    ...
    */
    public AIExtendedEntity(EntityCreature player)
    {
        this.player = player;
     ...
     */
    public static final void register(EntityCreature player)
    {
        player.registerExtendedProperties(AIExtendedEntity.EXT_PROP_NAME, new AIExtendedEntity(player));
    }
     ...
     * This method is for convenience only; it will make your code look nicer
     */
    public static final AIExtendedEntity get(EntityCreature player)
    {
        return (AIExtendedEntity) player.getExtendedProperties(EXT_PROP_NAME);
    }
