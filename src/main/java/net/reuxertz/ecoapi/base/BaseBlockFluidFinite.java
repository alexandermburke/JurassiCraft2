...
public class BaseBlockFluidFinite extends BlockFluidFinite
{
    ...
    public float getFluidHeightForRender(IBlockAccess world, BlockPos pos)
    {
        ...
        if (state.getBlock() == this)
        {
            ...
            {
                return .888888888888889F;
            }
        }
        return !state.getBlock().getMaterial().isSolid() && verticalOrigin == this ? 1 : this.getQuantaPercentage(world, pos) * .888888888888889F;
    }
