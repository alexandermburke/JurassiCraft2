...
public class BaseFruit extends BlockDirectional implements IGrowable {

    public static final PropertyInteger AGE = PropertyInteger.create("age", 0, 2);

    public Item itemDropped;

    public BaseFruit(Item itemDropped)
    {
    ...
    public boolean canBlockStay(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        return iblockstate1.getBlock() == Blocks.leaves || iblockstate1.getBlock() == Blocks.leaves2;
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        switch (BaseFruit.SwitchEnumFacing.FACING_LOOKUP[enumfacing.ordinal()])
        {
            case 1:
    ...
    public java.util.List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune)
    {
        ...
        for (int k = 0; k < b0; ++k)
        {
            dropped.add(new ItemStack(this.itemDropped));
        }
        return dropped;
    }
