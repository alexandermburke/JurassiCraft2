...
public class BlockStack extends Block
{
    public static final int LayerCount = 64;
    public static final PropertyInteger LAYERS = PropertyInteger.create("layers", 1, 64);
