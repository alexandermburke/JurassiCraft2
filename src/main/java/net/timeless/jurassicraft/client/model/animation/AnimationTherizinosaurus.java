...
public class AnimationTherizinosaurus implements IModelAnimator
{
    ...
    {        
        AnimatorJabelar theAnimator = new AnimatorJabelar(parModel);

        parModel = theAnimator.performJabelarAnimations(parModel, f, f1, rotation, rotationYaw, rotationPitch, partialTicks, parEntity);
