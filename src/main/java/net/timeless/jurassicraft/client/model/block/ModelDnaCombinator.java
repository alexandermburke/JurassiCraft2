package net.timeless.jurassicraft.client.model.block;

import net.minecraft.client.model.ModelBase;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;

public class ModelDnaCombinator extends ModelBase
{
    ...
    public ModelDnaCombinator()
    {
        this(0.0f);
    }

    public ModelDnaCombinator(float par1)
    {
