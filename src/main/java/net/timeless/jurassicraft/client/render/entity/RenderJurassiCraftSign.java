...
public class RenderJurassiCraftSign extends Render
{
    ...
    public void doRender(EntityJurassiCraftSign entity, double x, double y, double z, float p_76986_8_, float partialTicks)
    {
        ...
        GlStateManager.rotate(180.0F - entity.field_174860_b.getHorizontalIndex() * 90, 0.0F, 1.0F, 0.0F);
        GlStateManager.enableRescaleNormal();
        this.bindEntityTexture(entity);
        float f2 = 0.03125F;
        GlStateManager.scale(f2, f2, f2);
        this.func_77010_a(entity, 256, 256, 0, 0);
        GlStateManager.disableRescaleNormal();
        GlStateManager.popMatrix();
        super.doRender(entity, x, y, z, p_76986_8_, partialTicks);
    }

    protected ResourceLocation func_180562_a(EntityJurassiCraftSign p_180562_1_)
    {
        return texture;
    }

    private void func_77010_a(EntityJurassiCraftSign p_77010_1_, int p_77010_2_, int p_77010_3_, int p_77010_4_, int p_77010_5_)
    {
    ...
    private void func_77008_a(EntityJurassiCraftSign p_77008_1_, float p_77008_2_, float p_77008_3_)
    {
    ...
    {
        return this.func_180562_a((EntityJurassiCraftSign) entity);
    }
