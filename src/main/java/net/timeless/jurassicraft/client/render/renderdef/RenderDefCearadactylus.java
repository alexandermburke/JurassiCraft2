...
import net.timeless.jurassicraft.client.model.animation.AnimationCearadactylus;
...
public class RenderDefCearadactylus extends RenderDinosaurDefinition
{
    private IModelAnimator animator;
    private ModelJson model;

    public RenderDefCearadactylus()
    {
        super(JCEntityRegistry.cearadactylus);

        this.animator = new AnimationCearadactylus();
