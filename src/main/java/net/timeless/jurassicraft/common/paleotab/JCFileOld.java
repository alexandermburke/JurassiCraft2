...
//
//public class JCFileOld
//{
//    private boolean directory;
//    private String name;
//
//    private List<JCFileOld> children = new ArrayList<>();
//    private JCFileOld parent;
//
//    private EntityPlayer player;
//
//    private NBTTagCompound nbt;
//
//    public JCFileOld(EntityPlayer player, JCFileOld parent, String name)
//    {
//        this.name = name;
//        this.parent = parent;
//        this.player = player;
...
//    }
//
//    public static JCFileOld readFromNBT(NBTTagCompound nbt, EntityPlayer player, JCFileOld parent)
//    {
//        JCFileOld file = new JCFileOld(player, parent, nbt.getString("Name"));
//
//        file.directory = !nbt.hasKey("Data");
//
//        if(file.directory)
//        {
...
//    }
//
//    public void addChild(JCFileOld file)
//    {
