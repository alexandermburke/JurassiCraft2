...
import net.timeless.jurassicraft.container.slot.SlotWashWater;
...
public class ContainerCleaningStation extends Container
{
    ...
    public ContainerCleaningStation(InventoryPlayer invPlayer, IInventory cleaningStation)
    {
        ...
        for (i = 0; i < 3; i++)
        {
            for (int j = 0; j < 2; j++)
            {
                this.addSlotToContainer(new SlotFossil(cleaningStation, i + (j * 3) + 2, i * 18 + 93 + 15, j * 18 + 26));
            }
        }
