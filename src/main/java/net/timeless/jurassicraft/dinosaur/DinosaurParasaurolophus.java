...
public class DinosaurParasaurolophus extends Dinosaur
{
    ...
    public DinosaurParasaurolophus()
    {
        ...
        this.maleTextures = new String[] { "jurassicraft:textures/entities/parasaurolophus/parasaurolophus_male.png" };
        this.femaleTextures = new String[] { "jurassicraft:textures/entities/parasaurolophus/parasaurolophus_female.png" };

        try
        {
            this.model = getTabulaModel("/assets/jurassicraft/models/entities/parasaurolophus");
        }
        catch (Exception e)
        {
            e.printStackTrace();
