...
@IFMLLoadingPlugin.TransformerExclusions(value = "net.timeless.asm") // Your whole core mod package - Whatever you don't want the transformers to run over to prevent circularity Exceptions
@IFMLLoadingPlugin.SortingIndex(value = Integer.MAX_VALUE) // How early your core mod is called - Use > 1000 to work with srg names
