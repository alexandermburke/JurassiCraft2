...
public class RenderPaddockSign implements IRenderFactory<EntityPaddockSign>
{
    ...
    public static class Renderer extends Render<EntityPaddockSign>
    {
        ...
        public void doRender(EntityPaddockSign entity, double x, double y, double z, float yaw, float partialTicks)
        {
            ...
            this.drawPaddockSign(entity, 16, ((id) % 16) * 16, (int) Math.floor((id) / 16) * 16); // 8x16 art
        ...
        private void drawPaddockSign(EntityPaddockSign sign, int height, int textureU, int textureV)
        {
            float f = (float)(-16) / 2.0F;
            ...
            for (int x = 0; x < 16 / 16; ++x)
            {
                for (int y = 0; y < 16 / 16; ++y)
                {
                    ...
                    float f19 = (float)(textureU + 16 - x * 16) / 256.0F;
                    float f20 = (float)(textureU + 16 - (x + 1) * 16) / 256.0F;
