...
{
    public RenderDefIndominus(float babyScaleAdjustment, float parShadowSize)
    {
        super(JCEntityRegistry.indominus, new AnimationIndominus(), 3.4F, 0.4F, 0.65F, 0.0F, 0.0F);
    }
